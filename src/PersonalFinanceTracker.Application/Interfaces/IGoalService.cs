...
public interface IGoalService
{
    ...
    Task<GoalResponse> ContributeAsync(Guid userId, Guid id, decimal amount, CancellationToken ct = default);
    Task<GoalResponse> WithdrawAsync(Guid userId, Guid id, decimal amount, CancellationToken ct = default);
